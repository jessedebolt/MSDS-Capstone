...
# Fit the model
model_top5_Stroke <- train(Stroke ~ UrbanRural + Smoker + bpmUse + SNAPrecipients + Poverty + Smoker*UrbanRural + bpmUse*UrbanRural + SNAPrecipients*UrbanRural + Poverty*UrbanRural,
