...
plot_usmap(data = cdc_rural, values = "CHD") +
...
plot_usmap(data = cdc_urban, values = "CHD") +
  scale_fill_continuous(low = "blue", high = "red", name = "CHD",
                        label = scales::comma) +
  theme(legend.position = "right") +
