...
# Fit the model
model_top5 <- train(Stroke ~ . -county -state -CHD -HighChol -HighBP -Unemploy -pop -MedHouseIncome -AirQuality -Hospitals -CardioPhys -pcp -PhysInactivity -Obesity -Pharmacies -cruParticipate -CholScreen -Parks -Diabetes -CholMedNonAdhear -UrbanRural -CholMedElegible -EdLessColl -MedHomeValue -Broadband -HealthIns,  
                    data=cdc_tr_top5, 
                    method="lm", 
