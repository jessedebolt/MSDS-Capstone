...
| HCDI-PS-Neurologists | Count | Neuologists |
...
model <- randomForest(CHD ~ PrimaryCarePhys + Broadband + UrbanRural, data=train_set, ntree=100)
...
cardiovascular providers - CardioPhys
primary care providers - PrimaryCarePhys
hospitals - Hospitals
hospitals with cardiac intensive care centers - HospCIC
hospitals with cardiac rehabilitation centers - HospCR
