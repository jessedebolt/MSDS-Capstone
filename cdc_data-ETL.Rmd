...
#tried this but need to remove non numerical first
correlation_matrix <- cdc %>% select(-c(couty, state, "SEED-UR-Urban-Rural") %>% cor()
...
ggplot(data = cdc, aes(x = `SEED-UR-Urban-Rural`, y = `Prev-Coronary_Heart_Disease`, fill = `SEED-UR-Urban-Rural`)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(x = "SEED-UR-Urban-Rural", y = "Prevalence of CHD", fill = "SEED-UR-Urban-Rural") +
  theme(axis.text.x = element_text(angle = 45, hjust = 1))
