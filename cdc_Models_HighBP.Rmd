...
# Fit the model
model_top20 <- train(HighBP ~ . -county -state -CHD -HighChol -Stroke -pop -cruParticipate -Obesity -PhysInactivity -Parks -Hospitals, 
                    data=cdc_tr_top20, 
                    method="lm", 
...
# Fit the model
model_top15 <- train(HighBP ~ . -county -state -CHD -HighChol -Stroke -Unemploy -Pharmacies - SNAPrecipients -CholMedElegible -UrbanRural -pop -cruParticipate -Obesity -PhysInactivity -Parks -Hospitals,  
                    data=cdc_tr_top15, 
                    method="lm", 
...
# Fit the model
model_top10 <- train(HighBP ~ . -county -state -CHD -HighChol -Stroke -MedHouseIncome -CardioPhys -MedHomeValue -Broadband -HealthIns -Unemploy -Pharmacies - SNAPrecipients -CholMedElegible -UrbanRural -pop -cruParticipate -Obesity -PhysInactivity -Parks -Hospitals,  
                    data=cdc_tr_top10, 
                    method="lm", 
...
# Fit the model
model_top5 <- train(HighBP ~ . -county -state -CHD -HighChol -Stroke -AirQuality -pcp -Age65Plus -Smoker -EdLessColl -MedHouseIncome -CardioPhys -MedHomeValue -Broadband -HealthIns -Unemploy -Pharmacies - SNAPrecipients -CholMedElegible -UrbanRural -pop -cruParticipate -Obesity -PhysInactivity -Parks -Hospitals,  
                    data=cdc_tr_top5, 
                    method="lm", 
