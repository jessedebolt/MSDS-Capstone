...
numeric_columns <- numeric_columns[1:32]
...
## Median Home Value
```{r}
#need to fix this - 2 counties in SD and 2 in TX -66670000
cdc %>% select(c(state, MedHomeValue)) %>% arrange(MedHomeValue)
```
...
## Histograms to understand distribution of factors in rural and urban areas
