...
#create dataset for model (4:70)
cdc_basic <- cdc %>% dplyr::select("HighBP", "Age65Plus", "Smoker", "HealthIns", "Parks", "Cardio100k", "Obesity", "MedHouseIncome", "Diabetes", "CholScreen", "UrbanRural", "SNAPrecipients", "Broadband", "AirQuality", "Pharmacies", "Hosp100k", "Pharm100k", "EdLessColl", "PhysInactivity", "Hospitals", "Poverty", "TotalCardio", "pcp", "TotalPCP")
