...
# Use coalesce to replace NAs in PrimaryCarePhys and CardioPhys
cdc <- cdc %>% 
  mutate(
    PrimaryCarePhys = coalesce(PrimaryCarePhys, pcp),
...
cdc <- cdc %>%
  ...
  mutate(
    ...
    PrimaryCarePhys = replace_na(PrimaryCarePhys, median(PrimaryCarePhys, na.rm = TRUE))
  )
```
