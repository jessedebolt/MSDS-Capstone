...
# Fit the model
model_top15 <- train(HighChol ~ . -county -state -CHD -HighBP -Stroke -Obesity -UrbanRural -Parks -CardioPhys -MedHouseIncome -Hospitals -pop -Broadband -SNAPrecipients -Unemploy -cruParticipate,  
                    data=cdc_tr_top15, 
                    method="lm", 
...
# Fit the model
model_top10 <- train(HighChol ~ . -county -state -CHD -HighBP -Stroke -Obesity -UrbanRural -Parks -CardioPhys -MedHouseIncome -Hospitals -pop -Broadband -SNAPrecipients -Unemploy -cruParticipate -MedHomeValue -Poverty -Diabetes -pcp -CholMedNonAdhear,  
                    data=cdc_tr_top10, 
                    method="lm", 
...
# Fit the model
model_top5 <- train(HighChol ~ . -county -state -CHD -HighBP -Stroke -Obesity -UrbanRural -Parks -CardioPhys -MedHouseIncome -Hospitals -pop -Broadband -SNAPrecipients -Unemploy -cruParticipate -MedHomeValue -Poverty -Diabetes -pcp -CholMedNonAdhear -Pharmacies -PhysInactivity -CholMedElegible -EdLessColl -AirQuality,  
                    data=cdc_tr_top5, 
                    method="lm", 
