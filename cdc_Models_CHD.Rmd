...
# Fit the model
model_main <- train(CHD ~ . -county -state -Stroke -HighChol -HighBP , 
                    data=cdc_tr_main, 
                    method="lm", 
...
# Fit the model
model_top20 <- train(CHD ~ . -county -state -Stroke -HighChol -HighBP -Diabetes -CholScreen -CholMedNonAdhear -CardioPhys -AirQuality -Hospitals, 
                    data=cdc_tr_top20, 
                    method="lm", 
...
# Fit the model
model_top15 <- train(CHD ~ . -county -state -Stroke -HighChol -HighBP -Pharmacies -Obesity -Unemploy -MedHouseIncome -pop -Diabetes -CholScreen -CholMedNonAdhear -CardioPhys -AirQuality -Hospitals,  
                    data=cdc_tr_top15, 
                    method="lm", 
...
# Fit the model
model_top10 <- train(CHD ~ . -county -state -Stroke -HighChol -HighBP -Pharmacies -Obesity -Unemploy -MedHouseIncome -pop -Diabetes -CholScreen -CholMedNonAdhear -CardioPhys -AirQuality -Hospitals -cruParticipate -PhysInactivity -MedHomeValue -Broadband -CholMedElegible,  
                    data=cdc_tr_top10, 
                    method="lm", 
...
# Fit the model
model_top5 <- train(CHD ~ . -county -state -Stroke -HighChol -HighBP -Pharmacies -Obesity -Unemploy -MedHouseIncome -pop -Diabetes -CholScreen -CholMedNonAdhear -CardioPhys -AirQuality -Hospitals -cruParticipate -PhysInactivity -MedHomeValue -Broadband -CholMedElegible -UrbanRural -SNAPrecipients -pcp -Poverty -Parks,  
                    data=cdc_tr_top5, 
                    method="lm", 
